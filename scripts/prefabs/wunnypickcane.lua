local assets =
{
    ...
    -- Asset("IMAGE", "images/inventoryimages/cane.tex"),
}
...
local function fn()
    ...
    -- inst.components.inventoryitem.atlasname = "images/inventoryimages/cane.xml"
...
return Prefab("wunnypickcane", fn, assets)
