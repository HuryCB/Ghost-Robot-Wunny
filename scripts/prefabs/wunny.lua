...
local Walter_GetDoubleClickActions
...
local function Wortox_OnSetOwner(inst)
	if inst.components.playeractionpicker ~= nil then
		...
		inst.components.playeractionpicker.doubleclickactionsfn = Walter_GetDoubleClickActions
	end
end
...
function Walter_GetDoubleClickActions(inst, pos, dir, target)
...
local common_postinit = function(inst)
	...
	Walter_SetupMountedCommandWheel(inst)
	inst.HasWhistleAction = Walter_HasWhistleAction
	inst.TempFocusRememberChest = Walter_TempFocusRememberChest
	inst.CancelTempFocusRememberChest = Walter_CancelTempFocusRememberChest
	inst:ListenForEvent("updatewobycourierchesticon", Walter_OnUpdateWobyCourierChestIcon)
	...
	-- Walter_SetupMountedCommandWheel acabou de adicionar).
	inst.getlinkedspellbookfn = Walter_GetLinkedSpellBook
...
local master_postinit = function(inst)
	...
	--faz o mesmo por "isridingdirty" (ver Walter_OnIsRiding_Client); os dois lados
